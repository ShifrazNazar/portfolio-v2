...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Shifraz Nazar</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Shifraz Nazar, Portfolio,broken link ,missing page,link not found" />
        </Head>
    );
}
