...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Shifraz Nazar</title>
            ...
            <meta name="keywords" content="500, internal server error, Shifraz Nazar, Portfolio,broken link ,missing page,link not found" />
