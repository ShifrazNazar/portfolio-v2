                    ...
                    {hideContent ? null : (
                        <>
                            ...
                            <p style={{ fontSize: '14px', marginBottom: '30px' }}>
                                ...
                                <a href="https://github.com/ShifrazNazar/portfolio/issues/new">@ShifrazNazar</a>
                            </p>
                            {!isVerified ? (
                                <>
                    ...
                    {WelMsg && (
                        <div>
                            <h2 style={{ fontSize: '32px', marginBottom: '20px'}}>
                                <span dangerouslySetInnerHTML={{ __html: WelMsg.replace('Github', '<a href="https://github.com/ShifrazNazar" target="_blank" rel="noopener noreferrer" style="color: #3498db;">Github</a>') }} />
                            </h2>
                            {timerRemaining !== null && (
                ...
                {autoupdatecheck && (
                    ...
                    >
                        <p>
                            ...
                            {versionDetails ? (
                                <a
                                    href={`https://github.com/ShifrazNazar/portfolio/releases/tag/v${versionDetails.currentVersion}`}
                                    target="_blank"
